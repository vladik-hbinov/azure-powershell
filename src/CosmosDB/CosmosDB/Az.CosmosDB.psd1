...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Locations show response now includes status, isSubscriptionRegionAccessAllowedForRegular and isSubscriptionRegionAccessAllowedForAz properties'
