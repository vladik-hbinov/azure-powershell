...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fix the issue of System.Management.Automation.Internal.Host.InternalHost conflicting with system parameter System.Management.Automation.Internal.Host.InternalHost'
